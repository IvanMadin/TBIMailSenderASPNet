...
namespace EmailManager.Data.DataSeeder
{
    public static class ModelBuilderExtensions
    {
        public static void UserRoleSeeder(this ModelBuilder builder)
        {
            ...
            User krisiManager = new User { Id = "fe86f129-41f3-4ab8-a61c-5f47239a1393", UserName = "krisi", NormalizedUserName = "KRISI", Email = "krisi@gmail.com", NormalizedEmail = "KRISI@GMAIL.COM", LockoutEnabled = true, SecurityStamp = "7I5VNHIJTSZNOT3KDWKNFUV5PVYBHGXN", ChangedPassword = true };
            krisiManager.PasswordHash = hasher.HashPassword(krisiManager, "krisi123");

            User madinManager = new User { Id = "565dfbc0-2681-4f29-bc97-a619eacf339c", UserName = "madinftw", NormalizedUserName = "MADINFTW", Email = "madinftw@gmail.com", NormalizedEmail = "MADINFTW@GMAIL.COM", LockoutEnabled = true, SecurityStamp = "15CLJEKQCTLPRXMVXXNSWXZH6R6KJRRU", ChangedPassword = true};
        ...
        public static void StatusSeeder(this ModelBuilder builder)
        {
            builder.Entity<StatusEmail>().HasData(
                ...
                new StatusEmail { Id= "45d30b68-d0c1-499b-9ed0-c7385d4119b8", StatusType = "New Application" },
                new StatusEmail { Id = "645ad030-3b7f-47fb-93e1-1c9315b34673", StatusType = "Open Application" },
                new StatusEmail { Id = "6c60cb0a-5395-49b1-abfd-40a4db7a355a", StatusType = "Closed Application" });
        }
    }
}